                ...
                {Object.keys(WORKOUTS).map((type, typeIndex) => {
                    return (
                        <button onClick={() => {
                            setMuscles([])
                            setPoison(type)
                        }} className={'btn'+(type === poison ? ' text-blue-400' : ' text-white')} key={typeIndex}>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
                {Object.keys(SCHEMES).map((scheme, schemeIndex) => {
                    return (
                        <button onClick={() => {
                            setGoal(scheme)
                        }} className={'btn py-3 rounded-lg px-4 ' + (scheme === goal ? ' text-blue-400' : ' text-white')} key={schemeIndex}>
